...
require (
	...
	github.com/signalfx/splunk-otel-go/distro v1.21.0 // indirect
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/aws/aws-lambda-go/otellambda v0.56.0 // indirect
